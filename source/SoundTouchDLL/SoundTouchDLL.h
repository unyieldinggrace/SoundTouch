...
SOUNDTOUCHDLL_API unsigned int CDECL soundtouch_getVersionId();
...
SOUNDTOUCHDLL_API void CDECL soundtouch_setChannels(HANDLE h, unsigned int numChannels);

/// Sets sample rate.
SOUNDTOUCHDLL_API void CDECL soundtouch_setSampleRate(HANDLE h, unsigned int srate);
...
SOUNDTOUCHDLL_API unsigned int CDECL soundtouch_numUnprocessedSamples(HANDLE h);
...
SOUNDTOUCHDLL_API unsigned int CDECL soundtouch_receiveSamples(HANDLE h,
            float *outBuffer,           ///< Buffer where to copy output samples.
            unsigned int maxSamples     ///< How many samples to receive at max.
            );

/// Returns number of samples currently available.
SOUNDTOUCHDLL_API unsigned int CDECL soundtouch_numSamples(HANDLE h);
